...
from logic.core.operations import BinaryOp, Proposition
            ...
            if step.justification in inference_methods:
                ...
                try:
                    if (
                        ...
                        return None
                    elif step.justification == "Modus Ponens" and len(ref_statements) != 2:
                        # Silently fail for Modus Ponens with wrong number of dependencies
                        if self.debug:
                            logger.warning(f"Failed at step {step.step_number}: Modus Ponens requires exactly 2 dependencies")
                        return None
    ...
    def from_dict(cls, data: Dict) -> Proof:
        ...
        for step_data in steps_data:
            ...
            if isinstance(step_data.get("statement"), dict):
                from logic.core.base import LogicalExpression
                step_data["statement"] = LogicalExpression.from_dict(step_data["statement"])
